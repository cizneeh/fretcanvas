...
const messages = {
  en: {
    ...
    'tuning.apply': 'Apply',
    'tuning.applyWarning': 'Changing the tuning will clear displayed notes. Continue?',
    'tuning.addString': 'Add string',
    'tuning.cancel': 'Cancel',
    'tuning.custom': 'Custom',
    'tuning.deletePreset': 'Delete preset',
    'tuning.deletePresetConfirm': 'Delete this saved preset?',
    'tuning.note': 'Note',
    ...
    'tuning.title': 'Tuning',
    'tuning.preset.bass4': '4 Strings Bass',
    'tuning.preset.bass5': '5 Strings Bass',
    'tuning.preset.bass6': '6 Strings Bass',
    'tuning.preset.guitar7': 'Guitar 7 Strings',
  ...
  ja: {
    ...
    'tuning.apply': '適用',
    'tuning.applyWarning': 'チューニングを変更すると指板上の表示された音は失われます。続けますか？',
    'tuning.addString': '弦を追加',
    'tuning.cancel': 'キャンセル',
    'tuning.custom': 'カスタム',
    'tuning.deletePreset': 'プリセットを削除',
    'tuning.deletePresetConfirm': 'この保存済みプリセットを削除しますか？',
    'tuning.note': '音名',
    ...
    'tuning.title': 'チューニング',
    'tuning.preset.bass4': '4弦 ベース',
    'tuning.preset.bass5': '5弦 ベース',
    'tuning.preset.bass6': '6弦 ベース',
    'tuning.preset.guitar7': 'ギター 7弦',
