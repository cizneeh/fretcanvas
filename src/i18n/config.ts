...
const messages = {
  en: {
    ...
    'control.showExportRangeHighlights': 'Show export range highlights',
    ...
    'legend.nonChordTone': 'Non-chord Tone',
    'legend.nonScaleTone': 'Non-scale Tone',
    'legend.root': 'Root',
  ...
  ja: {
    ...
    'control.showExportRangeHighlights': 'エクスポート範囲のハイライトを表示',
    ...
    'export.rangeMulti': 'フレット {start} - {end}',
    'export.rangeSingle': 'フレット {start}',
